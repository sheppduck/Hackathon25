...
def main():
    # Example usage
    excel_file = "C:\\Projects\\Hackathon25\\cms_synthetic_claims\\claim_definitions.xlsx"
    db_file = "C:\\Projects\\Hackathon25\\cms_synthetic_claims\\cms_synthetic_claims.db"
